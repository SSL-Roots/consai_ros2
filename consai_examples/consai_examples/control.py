...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--id',
                            ...
                            type=int,
                            help='ロボットID')
    arg_parser.add_argument('--sub_id',
                            default=1,
                            type=int,
                            help='サブロボットID')
    ...
    arg_parser.add_argument('--y',
                            ...
                            type=float,
                            help='目標座標y')
    arg_parser.add_argument('--theta',
                            default=0.0,
                            type=float,
                            help='目標角度')
    arg_parser.add_argument('--example',
                            default=0,
                            type=int,
                            help='実行したい関数の番号\n' + examples_text)
