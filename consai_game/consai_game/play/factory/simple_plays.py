...
def our_free_kick() -> Play:
    ...
    return Play(
        ...
        roles=[
            ...
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(-3.0, 2.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(-3.0, 0.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(-3.0, -2.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(0.0, 4.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(0.0, 2.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(0.0, -2.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(0.0, -4.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(3.0, 3.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(3.0, -3.0)))],
            [CompositeOffense(is_setplay=True, kick_score_threshold=50, tactic_default=WrapperLookBall(Position(3.0, 0.0)))],
        ],
    )
...
def our_kick_off() -> Play:
    ...
    return Play(
        ...
        roles=[
            ...
            [WrapperLookBall(ChaseOrPosition(-3.5, -0.5))],
            [WrapperLookBall(ChaseOrPosition(-3.5, -1.5))],
            [WrapperLookBall(ChaseOrPosition(-2.0, 1.1))],
            [WrapperLookBall(ChaseOrPosition(-2.0, 0.3))],
            [WrapperLookBall(ChaseOrPosition(-2.0, -1.1))],
            [WrapperLookBall(ChaseOrPosition(-0.3, 2.5))],
...
def our_kick_off_start() -> Play:
    ...
    return Play(
        ...
        roles=[
            [AllowMoveInDefenseArea(WrapperLookBall(Position(-6.0, 0.0)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-3.5, 1.5)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-3.5, 0.5)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-3.5, -0.5)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-3.5, -1.5)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-2.0, 1.1)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-2.0, 0.0)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-2.0, -1.1)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-0.5, 2.5)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-0.5, 0.0)))],
            [CompositeOffense(is_setplay=True, force_pass=True, tactic_default=WrapperLookBall(Position(-0.5, -2.5)))],
        ],
    )
