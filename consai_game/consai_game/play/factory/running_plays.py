...
def in_our_defense_area() -> Play:
    ...
    return Play(
        ...
        roles=[
            [AllowMoveInDefenseArea(WrapperLookBall(CompositeGoalie()))],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(-3.0, 2.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(-3.0, 0.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(-3.0, -2.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(0.0, 4.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(0.0, 2.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(0.0, -2.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(0.0, -4.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(3.0, 3.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(3.0, -3.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=WrapperLookBall(Position(4.0, 0.0)), is_setplay=False)],
        ],
    )
