...
def in_our_defense_area() -> Play:
    ...
    return Play(
        ...
        roles=[
            ...
            [CompositeDefense(tactic_default=CenterBack(), do_receive=True)],
            [CompositeDefense(tactic_default=CenterBack(), do_receive=True)],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(0.0, -4.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(0.0, 4.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(-2.0, -2.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(-2.0, 2.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(-3.0, -4.0))))],
...
def in_their_defense_area() -> Play:
    ...
    return Play(
        ...
        roles=[
            [AllowMoveInDefenseArea(WrapperLookBall(CompositeGoalie()))],
            [CompositeOffense(tactic_default=MoveToReceivePass(Position(4.0, 2.0)), is_setplay=False)],
            [CompositeOffense(tactic_default=MoveToReceivePass(Position(4.0, -2.0)), is_setplay=False)],
            [CompositeDefense(tactic_default=CenterBack(), do_receive=True)],
            [CompositeDefense(tactic_default=CenterBack(), do_receive=True)],
            [CompositeDefense(tactic_default=CenterBack(), do_receive=True)],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(2.0, 0.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(0.0, -2.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(0.0, 2.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(-3.0, -4.0))))],
            [CompositeDefense(tactic_default=CompositeManMark(tactic_default=WrapperLookBall(Position(-3.0, 4.0))))],
        ],
