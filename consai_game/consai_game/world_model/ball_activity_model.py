...
class BallActivityModel:
    ...
    def update(
        ...
        # ボールの最終的な停止位置を予測する
        self.ball_stop_position = self.prediction_ball_stop_position(ball=ball, game_config=game_config)
    ...
    def prediction_ball_stop_position(self, ball: BallModel, game_config: GameConfigModel) -> State2D:
        """ボールが止まる位置を予測するメソッド."""
