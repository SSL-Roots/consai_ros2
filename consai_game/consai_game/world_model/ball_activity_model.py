...
from consai_game.perception.ball_perception import is_ball_will_enter_their_goal, predict_ball_stop_position, prediction_next_ball_pos
...
class BallActivityModel:
    ...
    def update(
        ...
        # ボールの最終的な停止位置を予測する
        self.ball_stop_position = predict_ball_stop_position(ball=ball, game_config=game_config)

        # ボールが相手のゴールに入るかを判定する
        self.ball_will_enter_their_goal = is_ball_will_enter_their_goal(
            ball=ball,
