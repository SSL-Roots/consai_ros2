...
RobotTracker::RobotTracker(const int team_color, const int id)
{
...
TrackedRobot RobotTracker::update(const double dt)
{
  // 観測値から外れ値を取り除く
...
bool RobotTracker::is_outlier(const TrackedRobot & observation)
{
  // TODO:implement this.
  return false;
}
